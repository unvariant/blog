...
It's been so long since I originally solved this challenge that I forgot some details haha... But I still remember most of it. The challenge involved a patch to qemu adding custom "slice" instructions.
