...
<html>
    <head>
        ...
        { props.children.props.title ? <title>{ props.children.props.title }</title> : null }
    ...
    <body>
        { (props.noDefaultFolders || false) ? <></> : [
            fileEntry(props.children.props.info, {
                filename: "."
            }),
            fileEntry(props.children.props.info.parentInfo, {
                filename: ".."
            }),
        ]}
